...
nome_relatorio = "Relatório de HyperDetect"
###############################################################
            ...
            if nome_relatorio in anexo.filename:
                ...
                with open(nome_do_arquivo, 'wb') as arquivo_excel:
                    ...
                    mapeamento_renomeacao = {
                        "Caminho do Arquivo": "endpointCaminhoDoArquivo",
                        "Endpoit afetado": "endpointAfetado",
                        "FQDN do endpoint afetado": "endpointFQDN",
                        "Módulo de Segurança": "endpointModuloDeSeguranca",
                        "Tipo de ataque": "endpointTipoDeAtaque",
                        "Status": "endpointStatus",
                        "Nível de Detecção": "endpointNivelDeDeteccao",
                        "Contar": "endpointContar",
                        "Última detecção": "endpointUltimaDeteccao",
                        "Ataque sem arquivo": "endpointAtaqueSemArquivo",
                        "Razão de detecção": "endpointRazaoDeDeteccao",
                        "Linha de comando": "endpointLinhaDeComando",
                        "Nome do Malware": "endpointNomeMalware",
                        "Hash": "endpointHash"
                    }
