            ...
            if nome_relatorio in anexo.filename:
                ...
                with open(nome_do_arquivo, 'wb') as arquivo_excel:
                    ...
                    mapeamento_renomeacao = {
                        ...
                        "IP": "endpointIP",
                        "Status da Atualização": "endpintStatusDaAtualizacao",
                        "Última atualização": "endpointUltimaAtualizacao",
                        "Antimalware": "endpointAntimalware",
                        "Gerenciado": "endpointGerenciado",
