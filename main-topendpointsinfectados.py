...
nome_relatorio = "Relatório de Top 10 Endpoints Infectados"
###############################################################
            ...
            if nome_relatorio in anexo.filename:
                ...
                with open(nome_do_arquivo, 'wb') as arquivo_excel:
                    ...
                    mapeamento_renomeacao = {
                        "Nome do Malware": "endpointNomeDoMalware",
                        "Tipo de Ameaça": "endpointTipoDeAmeaca",
                        "Limpo": "endpointLimpo",
                        "Ignorado": "endpointIgnorado",
                        "Em quarentena": "endpointEmQuarentena",
                        "Excluídos": "endpointExcluidos",
                        "Não resolvido": "endpointNaoResolvido",
                        "Última detecção": "endpointUtimaDeteccao",
                        "Nome do Endpoint": "endpointNomeEndpoint",
